...
> **작성일**: 2026-06-27
> **프로덕션 URL**: https://bsw-os.vercel.app
...
또는 직접 URL:
```
https://bsw-os.vercel.app/ko/{workspace_slug}/semantic-core/qis-triaxis
```
...
```
GET https://bsw-os.vercel.app/api/cron/qis-sync?secret=cron-a6ebf58c5057414186a53bc3&phase=all
```
...
```http
POST https://bsw-os.vercel.app/api/v1/qis/feedback
...
```
POST https://bsw-os.vercel.app/api/v1/qis/signals/ingest
X-QIS-Api-Key: bsw-qis-2026-e27b85e867954582
Content-Type: application/json
...
```
GET https://bsw-os.vercel.app/api/v1/qis/predictions?limit=50&min_confidence=0.7
X-QIS-Api-Key: bsw-qis-2026-e27b85e867954582
```
...
```bash
# URL 직접 호출
curl "https://bsw-os.vercel.app/api/cron/qis-sync?secret=cron-a6ebf58c5057414186a53bc3&phase=all"
