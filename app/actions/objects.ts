...
export async function createRepresentationObject(workspaceId: string, data: any) {
  ...
  const { createRepresentationObjectCore } = await import("../../lib/db/objects-db");
  return createRepresentationObjectCore(workspaceId, data);
}
...
export async function composeSemanticPage(workspaceId: string, contractId: string, data: any) {
  ...
  const { composeSemanticPageCore } = await import("../../lib/db/objects-db");
  return composeSemanticPageCore(workspaceId, contractId, data);
}
